...
// VALIDAR ID VALIDO
$id = $_GET["id"];
// filtramos el id entero FILTER VALIDATE_INT
$id = filter_var($id, FILTER_VALIDATE_INT);
// si no es entero, redireccionamos a index.php
if (!$id) {
	header("Location: /admin");
}
// mostrar con var_dump y pre
// echo '<pre>';
// var_dump($id);
// echo '</pre>';
...
// lo que hace solamente va a traer todo lo que tenga ese
// id, nombre, descripcion, precio, foto, tipo, habitaciones, baños, metros, antiguedad, ciudad, estado, pais, direccion, latitud, longitud, id_usuario
$consulta = "SELECT * FROM propiedades WHERE id = ${id}";
$resultado = mysqli_query($db, $consulta);
// no se necesita el white por que
// solamente es uno
...
$imgaenPropiedad = $propiedad["imagen"];
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	// ya no se necesita que se obligatoria
	...
	if (empty($errores)) {
		...
		// mejor opcion es update
		// las '' son para string
		// el where es obligatorio en un update
...
<main class="contenedor seccion">
	...
	<form class="formulario" method="POST" enctype="multipart/form-data">
		<fieldset>
			...
			<div class="div contenedor seccion darkmode-imagenActualizar">
				<img src="/imagenes/<?php echo $propiedad['imagen']; ?>" alt="foto de propiedad" class="imagen-chica-actualizar">
			</div>
